...
class AuditLogData:
    ...
    def to_dict(self):
        ...
        return {
            ...
            "oldValuesJson": json.dumps(jsonize(self.oldValuesJson)),
            "newValuesJson": json.dumps(jsonize(self.newValuesJson)),
            "affectedColumns":f'"{", ".join(self.guess_affected_cols())}"' if self.guess_affected_cols() else '',
            "role": self.role,
